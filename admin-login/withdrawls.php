...
?>
    ...
    <body id="body-pd">
        ...
        <div class="container">
            <div class="row py-5">
                <h5 class="text-white fw-bold">Withdrawls <span class="search-box float-end"><input type="search" placeholder="Search" name="search" id="search"></span></h5>
                <div class="overview">
                    <div class="row">
                        <?php

                        $query = "SELECT * FROM withdrawls ORDER BY id DESC";
                        ...
                        if ($rowCount > 0) {
                            ...
                            while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                if ($status == 'pending') {
                                    $status = "<p class='text-center text-danger'><i class='bx bx-history d-block'></i>&nbsp;Pending</p>";
                                } else {
                                    $status = "<p class='text-center text-success'><i class='bx bx-check-circle d-block'></i>&nbsp;Success</p>";
                                }

                                echo "
                                            <div class='col-lg-3 col-12'>
                                                <div class='card my-3 user'>
                                                    <img src='../assets/wallet-admin.svg' alt='users' class='img-fluid mt-5 mx-5'>
                                                    <div class='card-body'>
                                                        <h5 class='text-center text-price fw-bold'>$amount</h5>
                                                        <p class='text-center'>$phone</p>
                                                        $status
                                                        <br>
                                                        <a href='viewwithdraw?id=$id' class='advance-button shadow'>View&nbsp;&nbsp;<i class='bx bx-right-arrow-alt'></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                    ";
